...
$(document).ready(function () {
    ...
    $("#jsonexport").on("click", function () {
        ...
        jsonObject["selectrecord"] = checkedValues;
        ...
        fetch('/exportdata', {
            ...
            .then(data => {
                ...
                downloadFile(`http://dailogwave.site/${output_path}`);
    ...
    // Example usage: getting all checked checkbox values
    $("#deletedatanew").on("click", function () {
        const checkedValues = getCheckedCheckboxValues();
        console.log("Checked Values:", checkedValues);
        const jsonObject = {};
        jsonObject["selectrecord"] = checkedValues;
    ...
    $("#emailsubmit").on("click", function () {
        ...
        const mail = document.getElementById('subjectmail').value;

        formData.append('emailsubject', subject);
        formData.append('subjectmail', mail);
        formData.append('selectrecord', checkedValues);
    ...
    $("#callssubmit").on("click", function () {
        ...
        const simplecampaignname = document.getElementById('simplecampaignname').value;
        const simplemaxretry = document.getElementById('simplemaxretry').value;
        const smarttext = document.getElementById('smarttext').value;
        const simplevoiceid = document.getElementById('simplevoiceid').value;
        const smartvoiceselected = document.getElementById('smartvoiceselected').value;

        formData.append('simplecampaignname', simplecampaignname);
        formData.append('simplemaxretry', simplemaxretry);
        formData.append('smartvoiceselected', smartvoiceselected);
        formData.append('smarttext', smarttext);
        formData.append('simplevoiceid', simplevoiceid);
        formData.append('selectrecord', checkedValues);

        fetch('/smart_bulk_calling', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
